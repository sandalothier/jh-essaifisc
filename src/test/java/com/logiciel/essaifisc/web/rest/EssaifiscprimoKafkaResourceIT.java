package com.logiciel.essaifisc.web.rest;

import com.logiciel.essaifisc.config.KafkaProperties;
...
class EssaifiscprimoKafkaResourceIT {
    ...
    void setup() {
        ...
        EssaifiscprimoKafkaResource kafkaResource = new EssaifiscprimoKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc.perform(post("/api/essaifiscprimo-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc.perform(get("/api/essaifiscprimo-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
