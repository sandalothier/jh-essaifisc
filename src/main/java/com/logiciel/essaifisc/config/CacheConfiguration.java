package com.logiciel.essaifisc.config;
...
public class CacheConfiguration implements DisposableBean {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("essaifiscprimo");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("essaifiscprimo");
        ...
        config.getMapConfigs().put("com.logiciel.essaifisc.domain.*", initializeDomainMapConfig(jHipsterProperties));
