...
@RestController
@RequestMapping("/api/essaifiscprimo-kafka")
public class EssaifiscprimoKafkaResource {

    private final Logger log = LoggerFactory.getLogger(EssaifiscprimoKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public EssaifiscprimoKafkaResource(KafkaProperties kafkaProperties) {
